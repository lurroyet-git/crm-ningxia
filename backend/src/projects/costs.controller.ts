...
export class CostsController {
  ...
  async create(
    ...
    @Body() body: { type: string; category: string; amount: string; description?: string; vendor?: string; invoiceNo?: string; date?: string; status?: string },
  ) {
  ...
  async update(
    @Param('id') id: string,
    @Body() body: Partial<{ type: string; category: string; amount: string; description: string; vendor: string; invoiceNo: string; date: string; status: string }>,
  ) {
